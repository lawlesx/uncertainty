...
const socials = [
  ...
  {
    href: 'https://www.linkedin.com/in/aniruddhasil',
    icon: (
      <svg
        fill="#f6f6f6"
        xmlns="http://www.w3.org/2000/svg"
...
const Socials = () => {
  return (
    <motion.div
      ...
      initial="hidden"
      animate="visible"
      className="flex flex-col justify-between items-center pb-28 lg:py-20 lg:h-screen"
    >
      ...
      <p
        className="text-highlight text-[1rem] hidden lg:block"
        style={{ writingMode: 'vertical-lr' }}
      >
        Relish the Cosmic Uncertainty
      </p>
    </motion.div>
  )
}
